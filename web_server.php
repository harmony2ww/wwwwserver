...
class WwwwServer
{
	...
	**/
	...
	{
		if ($this -> _securityArrayStatuses === true && $this->securityCheck($temporaryUri["x_file"]) === false) {
			return false;
		}
		if ($this -> _securityFilesWebStataStuses === true && $this->securityCheckWebFiles($temporaryUri["x_file"]) === false) {
			return false;
		}
